  ...
  <!-- Modal Vet -->
  <div class="modal fade" id="VetModal" tabindex="-1" aria-labelledby="exampleVetModal" aria-hidden="true">
    <div class="modal-dialog modal-xl modal-dialog-centered ">
      <div class="modal-content bg-sky">
        <div class="modal-header">
          <h5 class="modal-title text-sky" id="exampleVetModal">คลินิกพิเศษ</h5>
          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
        <div class="modal-body">
              <!-- หมอประจำคลิกนิคเฉพาะทาง -->
            <div class="container-fluid bg-light py-5">
              <div class="container">
                
                <div class="row row-cols-1 row-cols-lg-5 g-2 g-lg-3 g-4 justify-content-center">
                <!-- vet 1 -->
  ...
  <!-- Modal surgery -->
  <div class="modal fade" id="surgery" tabindex="-1" aria-labelledby="surgery1" aria-hidden="true">
    <div class="modal-dialog modal-xl modal-dialog-centered ">
      <div class="modal-content bg-sky">
        <div class="modal-header">
          <h5 class="modal-title" id="surgery1">ศัลยกรรม</h5>
          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
        <div class="modal-body">
              <!-- ศัลยกรรม -->
            <div class="container-fluid bg-light py-5">
              <div class="container">
                ...
                <div class="col- wow fadeInUp" data-wow-delay="0.01s">
                  <div class="service-item bg-sky overflow-hidden h-100">
                    <div class="service-text position-relative text-center h-100 p-4">
                      <h6 class="mb-3">ศัลยกรรมเนื้อเยื่ออ่อน</h6>
                      <a href="surgery-1.php" type="button" class="btn btn-sky">
                        <img src="assets/images/iconศัลยกรรม/เนื้อเยื่ออ่อน.png" alt="/">
                      </a>
                    </div>
                  </div>
                </div>
                ...
                <div class="col wow fadeInUp" data-wow-delay="0.02s">
                  <div class="service-item bg-sky overflow-hidden h-100">
                    <div class="service-text position-relative text-center h-100 p-4">
                      <h6 class="mb-3">ศัลยกรรมกระดูก </h6>
                      <a href="surgery-2.php" type="button" class="btn btn-sky" >
                      <img src="assets/images/iconศัลยกรรม/กระดูก.png" alt="/">
                      </a>
                    </div>
                  </div>
                </div>
                ...
                <div class="col wow fadeInUp" data-wow-delay="0.04s">
                  <div class="service-item bg-sky overflow-hidden h-100">
                    <div class="service-text position-relative text-center h-100 p-4">
                      <h6 class="mb-3">วิสัญญี </h6>
                      <a href="surgery-3.php" type="button" class="btn btn-sky" >
                        <img src="assets/images/iconศัลยกรรม/วัญญี.png" alt="/">
                      </a>
                    </div>
                  </div>
                </div>
                ...
                <div class="col wow fadeInUp" data-wow-delay="0.04s">
                  <div class="service-item bg-sky overflow-hidden h-100">
                    <div class="service-text position-relative text-center h-100 p-4">
                      <h6 class="mb-3">ทันตกรรม </h6>
                      <a href="surgery-4.php" type="button" class="btn btn-sky" >
                        <img src="assets/images/iconศัลยกรรม/ทันตกรรม.png" alt="/">
                      </a>
                    </div>
                  </div>
                </div>
                ...
                <div class="col wow fadeInUp" data-wow-delay="0.03s">
                  <div class="service-item bg-sky overflow-hidden h-100">
                    <div class="service-text position-relative text-center h-100 p-4">
                      <h6 class="mb-3">ส่องกล้องตรวจ </h6>
                      <a href="surgery-5.php" type="button" class="btn btn-sky">
                        <img src="assets/images/iconศัลยกรรม/ส่องกล้อง.png" alt="/">
                      </a>
                    </div>
                  </div>
                </div>
